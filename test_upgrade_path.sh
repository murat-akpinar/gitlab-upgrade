...
repo=(
  ...
  18.0.0-ce.0 18.0.6-ce.0 18.1.5-ce.0 18.2.4-ce.0 18.2.10-ce.0 18.3.7-ce.0 18.4.3-ce.0
...
check 17.0.8 "17.1.8-ce.0 17.3.7-ce.0 17.5.5-ce.0 17.8.7-ce.0 17.11.10-ce.0 18.2.10-ce.0 18.3.7-ce.0 18.5.6-ce.0 18.8.5-ce.0 18.11.4-ce.0 19.2.5-ce.0 19.4.0-ce.0"
# Stop minor'undaysa önce o minor'ün en yeni patch'i, majör geçişte 18.0 değil doğrudan 18.2.latest
check 17.11.2 "17.11.10-ce.0 18.2.10-ce.0 18.3.7-ce.0 18.5.6-ce.0 18.8.5-ce.0 18.11.4-ce.0 19.2.5-ce.0 19.4.0-ce.0"
# 18.3 (sent_notifications düzeltmesi) stop; 18.4.3 atlanır
check 18.3.1 "18.3.7-ce.0 18.5.6-ce.0 18.8.5-ce.0 18.11.4-ce.0 19.2.5-ce.0 19.4.0-ce.0"
...
# 18.5 repoda yok ama 18.8 var -> 18.3'ten 18.8'e atlanmamalı
repo=(18.3.7-ce.0 18.4.1-ce.0 18.8.11-ce.0 18.11.11-ce.0)
expect_fail 18.3.7
...
repo=(18.11.4-ce.0)
check 18.11.4 ""
# 18.2.8 (bizim takıldığımız yer) -> önce 18.3
repo=(18.2.8-ce.0 18.3.7-ce.0 18.5.7-ce.0)
check 18.2.8 "18.3.7-ce.0 18.5.7-ce.0"
